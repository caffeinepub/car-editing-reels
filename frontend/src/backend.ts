...
import type { ExternalBlob as _ExternalBlob, ImageId as _ImageId, StoredImage as _StoredImage, Timestamp as _Timestamp, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllImages(): Promise<Array<StoredImage>> {
        if (this.processError) {
            try {
    ...
    async getImage(arg0: ImageId): Promise<StoredImage | null> {
        if (this.processError) {
            try {
    ...
    async uploadImage(arg0: ExternalBlob): Promise<ImageId> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadImage(await to_candid_ExternalBlob_n18(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_StoredImage_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _StoredImage): Promise<StoredImage> {
...
async function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_StoredImage]): Promise<StoredImage | null> {
    return value.length === 0 ? null : await from_candid_StoredImage_n11(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_StoredImage>): Promise<Array<StoredImage>> {
    return await Promise.all(value.map(async (x)=>await from_candid_StoredImage_n11(_uploadFile, _downloadFile, x)));
}
