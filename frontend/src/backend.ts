...
export class Backend implements backendInterface {
    ...
    async filterByTag(arg0: string, arg1: ViewRange): Promise<Array<Reel>> {
        if (this.processError) {
            try {
                const result = await this.actor.filterByTag(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getFeaturedReels(arg0: ViewRange): Promise<Array<Reel>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFeaturedReels(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async incrementViewCount(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async submitReel(arg0: NewReel): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitReel(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
